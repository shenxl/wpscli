---
name: wps-helper-app-files
version: 1.0.0
description: "WPS helper command: app-files"
metadata:
  openclaw:
    category: "productivity"
    requires:
      bins: ["wpscli"]
    cliHelp: "wpscli app-files --help"
    auth_types: ["user", "app"]
---
...
- Scope: files 助手别名（兼容旧调用方式）

```bash
wpscli app-files <command> [flags]
```
